...
if __name__ == '__main__':
    pdf = my_cust_PDF()
    data=[['ID Number','Name','Gender','Phone No','Room','Check-in','Amount','Deposit'],
          ['ID Number','Name','Gender','Phone No','Room','Check-in','Amount','Deposit'],
          ['ID Number','Name','Gender','Phone No','Room','Check-in','Amount','Deposit']]

    headings = ['ID Number','Name','Gender','Phone No','Room','Check-in','Amount','Deposit']
